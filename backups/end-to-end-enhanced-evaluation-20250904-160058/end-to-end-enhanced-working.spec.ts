...
test.describe('End-to-End Enhanced Evaluation - Working Version', () => {
  test('Complete FAQ evaluation with enhanced GEval metrics', async ({ page, browser }) => {
    ...
    console.log('🚀 Starting End-to-End Enhanced Evaluation...');
    ...
    if (await chatIframe.count() > 0) {
      ...
      if (chatFrame) {
        ...
        // Step 8: Create evaluators
        console.log('\n🔍 STEP 8: Creating Evaluation Systems');
        ...
        // Step 9: Conduct FAQ evaluation with both systems
        console.log('\n💬 STEP 9: Conducting Comprehensive FAQ Evaluation');
        ...
        for (let i = 0; i < questions.length; i++) {
          ...
          try {
            ...
            await newPage.screenshot({
              path: `reports/ui/enhanced-faq-q${i + 1}-response.png`,
              fullPage: true
            });
        ...
        // Step 10: Generate comprehensive evaluation report
        console.log('\n📊 STEP 10: Generating Comprehensive Evaluation Report');
        ...
        console.log('\n🎯 ===== END-TO-END ENHANCED EVALUATION COMPLETE =====');
