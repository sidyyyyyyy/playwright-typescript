...
test.describe('PolicyHolder Agent - Address Update Flow Test', () => {
  test('Create PolicyHolder Agent and Test Address Update Flow', async ({ page }) => {
    test.setTimeout(600000); // 10 minutes for full flow
    
    console.log('🏢 Starting PolicyHolder Agent Address Update Flow Test...');
    ...
    // Step 5: Find and click on our created PolicyHolder agent
    ...
    await newPage.screenshot({ 
      path: 'reports/policyholder-address-update-initial.png',
      fullPage: true 
    });
    ...
    console.log('✅ Prepared 3-step address update flow');
    ...
    for (let i = 0; i < addressUpdateQueries.length; i++) {
      ...
      try {
        ...
        await newPage.screenshot({ 
          path: `reports/policyholder-address-update-step-${i + 1}.png`,
          fullPage: true 
        });
    ...
    console.log('\n🎯 ===== POLICYHOLDER ADDRESS UPDATE FLOW COMPLETE =====');
    ...
    console.log('\n✅ PolicyHolder Address Update Flow completed successfully!');
